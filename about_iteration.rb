...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # --
    # It performs aggregation of the array items using the provided seed and the aggregate function
  end
  ...
  # --
  # The block construct allows the file resources to be closed automatically once finished with it
